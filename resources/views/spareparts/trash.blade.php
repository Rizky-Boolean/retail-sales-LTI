        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Tabel Data (Dengan Gaya yang Disesuaikan) --}}
                                ...
                                <tr class="border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <td class="py-3 px-4 text-center">
                                        <div class="flex justify-center items-center gap-4">
                                            ...
                                            <button type="button" onclick="showDeleteModal('{{ route('spareparts.forceDelete', $sparepart->id) }}', '{{ addslashes($sparepart->nama_part) }}')" class="flex items-center gap-1 text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300" title="Hapus Permanen">
