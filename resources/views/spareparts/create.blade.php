                    ...
                    <form action="{{ route('spareparts.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                             ...
                             <div>
                                <x-input-label for="markup_persen" :value="__('Markup Profit Standar (%)')" />
                                <x-text-input id="markup_persen" name="markup_persen" type="number" step="0.01" class="mt-1 block w-full" :value="old('markup_persen', 40)" required />
