                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white dark:bg-gray-800">
                            ...
                            <tbody>
                                @forelse($spareparts as $sparepart)
                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <td class="py-3 px-4 text-center">
                                            <form action="{{ route('spareparts.toggleStatus', $sparepart) }}" method="POST" class="inline-block">
                                                @csrf
                                                @method('PATCH')
                                ...
                                @empty
                                    <tr><td colspan="2" class="text-center py-4">Tidak ada data sparepart nonaktif.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
