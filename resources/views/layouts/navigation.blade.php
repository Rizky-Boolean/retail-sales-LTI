<nav x-data="{ open: false }" class="bg-blue-900 border-b border-blue-800 dark:bg-gray-950 dark:border-gray-700 shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="p-2 bg-white rounded-full shadow-sm flex items-center justify-center">
                        <img src="{{ asset('images/logo lautan teduh.png') }}" alt="Logo" class="block h-8 w-auto object-contain">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @if(in_array(auth()->user()->role, ['super_admin', 'admin_gudang_induk', 'admin_gudang_cabang']))
                    <div class="ms-3 mr-4 relative" x-data="{ open: false }">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-blue-800 dark:bg-gray-900">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- Menu untuk Pengelola Gudang Induk (Super Admin & Admin Gudang Induk) --}}
            @if(in_array(auth()->user()->role, ['super_admin', 'admin_gudang_induk']))
                <x-responsive-nav-link :href="route('distribusi.index')" :active="request()->routeIs('distribusi.*')">Distribusi</x-responsive-nav-link>
            @endif
