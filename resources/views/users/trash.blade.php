                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white dark:bg-gray-800">
                            ...
                            <tbody>
                                @forelse($users as $user)
                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <td class="py-3 px-4 text-center">
                                            ...
                                            <form action="{{ route('users.forceDelete', $user->id) }}" method="POST" class="inline-block ml-2">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <tr><td colspan="4" class="text-center py-4">Tidak ada data di dalam trash.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
